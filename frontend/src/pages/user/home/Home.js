...
import BookListMenu from "../books/BookListMenu";
import MovieList from "../movies/MovieListMenu";
import "./Home.css";
  ...
  return (
    <Layout>
      <div>
        ...
        <p>
          LibraFlick transforms the way you manage and engage with your library
          of books and movies, offering unparalleled convenience, exploration,
          and enjoyment. Join our community today and embark on a journey of
          literary and cinematic discovery like never before.
        </p>
